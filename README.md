...
<h3> Add CSS, images, and other graphics to make website look more professional;<h3/> <br> remove jumbotrons, etc.  <br>

<h3> Get the database working!!<h3/>   <br>
  
<h3> Add mini apis for each of the individual states pages<h3/> <br> have them show live data, as opposed to typed numbers  <br>
  
<h3> Add exclusive section for people who log in<h3/> <br> analyze their risk based on their location/other factors  <br>

<h3> Incorporate Scrum Crossover suggestions: <h3/> <br> Having the database login take you to an individual page for each user, add commas for the numbers on the table so it would be easier to look at the data. 
 <br>
